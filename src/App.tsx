...
const lofiPlaylist: Song[] = [
  ...
  },
  {
    title: "Chill Study",
    artist: "Calm Beats",
    url: "https://cdn.pixabay.com/download/audio/2022/03/15/audio_861a31a15f.mp3"
  },
  {
    title: "Deep Focus",
    artist: "Mind Wanderer",
    url: "https://cdn.pixabay.com/download/audio/2022/01/18/audio_d0c6435fe7.mp3"
  }
];
                ...
                {predefinedGradients.map((gradient) => (
                  <button
                    ...
                    className={`p-2 rounded-lg text-white text-sm ${
                      selectedGradient === gradient && !useCustomGradient
                        ? 'bg-white/30'
